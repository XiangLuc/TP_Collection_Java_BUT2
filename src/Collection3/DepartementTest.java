...
public class DepartementTest {
	...
	x = new Enseignant("Homps");
	y = new Enseignant("Simonot");
	z = new Enseignant("Aquil");
	t = new Enseignant("Picton");
    ...
    public void testlesResponsablesL2NomPuisIdentifiant() throws Exception {
		Enseignant nouveauHomps = new Enseignant("Homps");
...
//		Enseignant nouveauSimonot = new Enseignant("Simonot");
